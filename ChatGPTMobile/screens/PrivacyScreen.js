  ...
  const data = [
    ...
    <View style={styles.subTextContainer}>
      <Text style={styles.subtext(theme)}>
        All data, such as your conversations and your API key, are stored on
        your device's storage. Specifically, your API key is stored using Expo
        SecureStore, which encrypts and securely stores key–value pairs locally
        on your device.
      </Text>
    </View>,
  ];
